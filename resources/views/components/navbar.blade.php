...
}" @scroll.window="handleScroll" class="fixed w-full top-0 z-50 transition-all duration-300"
    :class="{
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex space-x-6 items-center">
                <a href="{{ route('about') }}" class="text-white hover:text-orange-400 transition-colors duration-200"
                ...
                <a href="{{ route('trainer') }}" class="text-white hover:text-orange-400 transition-colors duration-200"
                    :class="{ 'text-white': atTop, 'text-orange-500': !atTop }">
                    Trainer
                </a>
            ...
            <div class="flex items-center sm:hidden">
                <button @click="open = !open" type="button" class="text-white hover:text-orange-400 focus:outline-none"
                    :class="{ 'text-white': atTop, 'text-orange-500': !atTop }">
